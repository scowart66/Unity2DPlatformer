...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 5131931;
      var PACKAGE_UUID = '868f7a2a-7b0a-4f0d-ad8a-475132ee2f2a';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    new DataRequest(21804, 21823, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(21823, 1589667, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(1589667, 2722263, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2722263, 4609647, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4609647, 5131931, 0, 0).open('GET', '/Resources/unity_builtin_extra');
